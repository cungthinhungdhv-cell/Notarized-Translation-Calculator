...
function CounterRow({ label, hint, unitPrice, count, onChange, config }: CounterRowProps) {
  return (
...
export function PriceSummary({ results, config, onReset }: PriceSummaryProps) {
  ...
  const translationCopiesPrice = translationCopies * config.pricing.notaryCopyTranslation;
